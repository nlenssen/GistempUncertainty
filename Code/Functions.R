...
landMaskNewGrid <- function(reanalysis,lonRef,latRef,seasonalLandMaskRef){
	...
	save(seasonalLandMask,maximalLandMask,file=sprintf('Data/%s/landMasks_%s.Rda',reanalysis,reanalysis))
}
